...
#+begin_src emacs-lisp
  (global-set-key (kbd "C-c n")
                  (lambda () (interactive) (find-file "~/org/now.org")))
  (global-set-key (kbd "C-c o")
                  (lambda () (interactive) (find-file "~/org/orgbox.org")))
...
#+end_src
** TODO Tags
- These aren't working as I'd expect, there is no hotkey option for selecting tag on completion.
#+begin_src emacs-lisp
  (setq org-tag-alist
        '(("study" . ?s)
          ("10m" . ?t)
