...
#+begin_src elisp
  ...
  (set-face-attribute 'line-number nil :background "#00000000")  ;; line number background is too distinct
        ...
        (setq org-capture-templates
              '(
                ...
                ("b" "Current project buffer task" entry (file+headline buffer-name "Tasks")
                 "* TODO %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n"
                 :prepend t)
                ("c" "Task" entry (file+headline "~/org/cabcs.org" "Inbox")
                 "* TODO %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n"
                 :prepend t)
                ...
                ("m" "Meeting" entry (file+olp+datetree "~/org/meetings.org")
                 "p* %U %?"
                 :tree-type 'daily)
                ("s" "Study" entry (file "~/org/study.org")
                 "* TODO %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n"
                 :prepend t)
                ))
