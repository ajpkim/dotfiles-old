...
* Table of Contentes                                                    :toc:
:PROPERTIES:
:CUSTOM_ID: Table-of-Contentes
:ID:       7da33b7e-5dfd-4d14-a661-ce45dd9702cc
:END:
...
- [[File shortcuts & bookmarks][File shortcuts & bookmarks]]
  - [[Files][Files]]
  - [[Bookmarks][Bookmarks]]
- [[Org][Org]]
  - [[Setup (ellispsis, emphasis, indent, etc)][Setup (ellispsis, emphasis, indent, etc)]]
  - [[Global Org keys][Global Org keys]]
  - [[Extend day untill 2am][Extend day untill 2am]]
  - [[Export & Publishing][Export & Publishing]]
    - [[Export][Export]]
    - [[Publish][Publish]]
  - [[Agenda][Agenda]]
    - [[Base settings][Base settings]]
    - [[Agenda global TODO list decluttering][Agenda global TODO list decluttering]]
  ...
  - [[org-id][org-id]]
  - [[Modules][Modules]]
  - [[Images (allow for resizing with imagemagick)][Images (allow for resizing with imagemagick)]]
  - [[Hyphens to dots][Hyphens to dots]]
  - [[org-tempo][org-tempo]]
  - [[org-bullets][org-bullets]]
  - [[LaTeX][LaTeX]]
  - [[Fold non-current headers][Fold non-current headers]]
  - [[Never add new lines after headlines][Never add new lines after headlines]]
- [[magit][magit]]
...
- [[company][company]]
- [[olivetti][olivetti]]
- [[focus minor mode][focus minor mode]]
- [[Center scroll mode][Center scroll mode]]
...
- [[drag-stuff CONFLICT WITH ORG][drag-stuff CONFLICT WITH ORG]]
- [[Util Funcs][Util Funcs]]
  - [[Text editing][Text editing]]
  - [[Config edit/reload][Config edit/reload]]
  - [[window splitting functions][window splitting functions]]
...
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'default nil :height 150)  ;; Magnify text here
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c f w")
                  (lambda () (interactive) (my-shortcut "~/org/2021-w26.org")))
  (global-set-key (kbd "C-c f W")
  ...
  (setq org-capture-templates
        '(
          ...
          ("J" "Job Hunt" entry (file+headline "~/org/work.org" "Apps")
           "* TODO %^\n:PROPERTIES:\n:CREATED: %U\n:APP: %^\n:POSITION: %^\n:FIELD: %^\n:INNOVATIVE: %^\n:LOCATION: %^\n:END:\n%?"
           :prepend t)
          ("t" "Add a task for today" entry (file "~/org/inbox.org")
           "* TODO %?\nSCHEDULED: <%<%Y-%m-%d %a>>\n:PROPERTIES:\n:ID: %(shell-command-to-string \"uuidgen\"):CREATED: %U\n:END:\n"
           :prepend t
           )
          ("z" "ZZZ" entry (file+datetree "~/org/zzz.org")
           "* %<%R >%? %^g\n%T")
          ))
#+end_src
