...
#+begin_src elisp
  ...
  (global-set-key (kbd "C-c f l")
                  (lambda () (interactive) (my/file-shortcut "~/org/learn.org")))
  ...
  (global-set-key (kbd "C-c f w")
                  (lambda () (interactive) (my/file-shortcut "~/org/web.org")))
  ...
  (setq org-capture-templates
        '(
          ...
          ("w" "Web" entry (file "~/org/web.org")
           "* %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n"
           :prepend t)
          ("x" "Read, Watch, Listen" entry (file "~/org/read-watch-listen.org")
           "* TODO %? %^g\n:PROPERTIES:\n:CREATED: %U\n:END:\n"
           :prepend t)
