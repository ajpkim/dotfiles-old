...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'default nil :height 130)  ;; control default size
...
:PROPERTIES:
:ID:       db8ee34e-1803-48e5-ba06-ec7dfb772e63
:END:
#+begin_src emacs-lisp
  ;; Modifying window layout
  (global-set-key (kbd "C-c h <left>") 'shrink-window-horizontally)
  (global-set-key (kbd "C-c h <right>") 'enlarge-window-horizontally)
  (global-set-key (kbd "C-c h <down>") 'shrink-window)
  (global-set-key (kbd "C-c h <up>") 'enlarge-window)

  (winner-mode 1)
  (global-set-key (kbd "<C-s-left>") 'winner-undo)
  (global-set-key (kbd "<C-s-right>") 'winner-redo)

  (global-set-key (kbd "<C-s-up>") 'ivy-push-view)
  (global-set-key (kbd "<C-s-down>") 'ivy-switch-view)


  ;; (setq scroll-preserve-screen-position 1)
  ;; (global-set-key (kbd "") kbd C-u 1 C-V
  ;; 		kbd C-u 1 M-v
...
** Basic hooks
:PROPERTIES:
:ID:       bce4abd4-2ef8-4fa9-8fad-165f9c2c218b
:END:
#+begin_src emacs-lisp
...
#+begin_src elisp
  ...
  (global-set-key (kbd "C-c h l") 'display-line-numbers-mode)
...
#+begin_src emacs-lisp
  ...
  (setq org-publish-project-alist
        '(
          ("ajpkim-blog"
           :base-directory "~/org/ajpkim.com/blog/"
           :base-extension "org"
           :publishing-directory "~/ajpkim.com/blog/"
           :recursive t
           :publishing-function org-html-publish-to-html
           :html-extension "html"
           :body-only nil
           :html-head "<link rel='stylesheet' type='text/css' href='../assets/css/styles.css'/>
  <script id='MathJax-script' async src='https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-mml-chtml.js'></script>"
           :html-head-extra nil
           :html-preamble nil)
          ("ajpkim-pages"
           :base-directory "~/org/ajpkim.com/pages"
           :base-extension "org"
           :publishing-directory "~/ajpkim.com/pages/"
           :recursive t
           :publishing-function org-html-publish-to-html
           :html-extension "html"
           :body-only nil
  ...
  <div> id=\"Updated: %C</div>")
          ("ajpkim-assets"
           :base-directory "~/org/ajpkim.com/assets/"
           :base-extension "css\\|scss\\|js\\|png\\|jpg\\|gif\\|pdf\\|mp3"
           :publishing-directory "~/ajpkim.com/assets/"
           :recursive t
           :publishing-function org-publish-attachment)

        ("ajpkim.com" :components ("ajpkim-blog" "ajpkim-pages"  "ajpkim-assets"))))
#+end_src

*** new [2021-10-03 Sun 19:28]
:PROPERTIES:
:ID:       54da4218-c765-4344-9ab1-b6bd05954f3c
:END:

#+begin_src emacs-lisp

  ;; ;; https://emacs-orgmode.gnu.narkive.com/YDCVeiVv/tag-search-and-invalid-face-error-from-htmlize-buffer
  ...
  ;; ;; src: https://www.taingram.org/blog/org-mode-blog.html
  ...
  ;; ;; Prettify timestamp export format
  ;; ;; src: https://stackoverflow.com/questions/23297422/org-mode-timestamp-format-when-exported
  ...
  ;; ;;;; Setup Org publishing configurations
  ...
  ;;          :body-only nil
  ;;          :html-head "<link rel='stylesheet' type='text/css' href='../assets/css/styles.css'/>
  ;; <link rel='stylesheet' type='text/css' href='../assets/css/modus-vivendi.css'/>
  ;; <script id='MathJax-script' async src='https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-mml-chtml.js'></script>"
  ;;          :html-head-extra "<style> a {color: #eceff4; text-decoration: underline #acdbff 2px;} </style>"  ;; underlined style links
  ...
  ;;         ("ajpkim-projects"
  ;;          :base-directory "~/org/ajpkim.com/projects/"
  ;;          :base-extension "org"
  ;;          :publishing-directory "~/ajpkim.com/projects/"
  ;;          :recursive t
  ;;          :publishing-function org-html-publish-to-html
  ;;          :html-extension "html"
  ;;          :body-only nil
  ...
  ;;         ("ajpkim-pages"
  ;;          :base-directory "~/org/ajpkim.com/"
  ;;          :base-extension "org"
  ;;          :publishing-directory "~/ajpkim.com/"
  ;;           :recursive t
  ;;          :publishing-function org-html-publish-to-html
  ;;          :html-extension "html"
  ;;          :body-only nil
  ...
  ;;         ("ajpkim-assets"
  ;;          :base-directory "~/org/ajpkim.com/assets/"
  ;;          :base-extension "css\\|scss\\|js\\|png\\|jpg\\|gif\\|pdf\\|mp3\\|ttf"
  ;;          :publishing-directory "~/ajpkim.com/assets/"
  ;;          :recursive t
  ;;          :publishing-function org-publish-attachment)
  ...
  (setq org-capture-templates
        '(
          ...
          ("d" "Dream journal" plain (file+olp+datetree "~/org/dreams.org")
           "%?"
           :tree-type 'daily)
          ("e" "Events" entry (file+headline "~/org/self.org" "Events")
           "* TODO %?\n:PROPERTIES:\n:ID: %(shell-command-to-string \"uuidgen\"):CREATED: %U\n:END:\n%a\n"
           :prepend: t)
          ...
          ("t" "Today task" entry (file "~/org/inbox.org")
           "* TODO %?\nSCHEDULED: <%<%Y-%m-%d %a>>\n:PROPERTIES:\n:ID: %(shell-command-to-string \"uuidgen\"):CREATED: %U\n:END:\n"
           :prepend t)
          ("w" "Work" entry (file+headline "~/org/cabcs.org" "Inbox")
           "* TODO %?\n:PROPERTIES:\n:ID: %(shell-command-to-string \"uuidgen\"):CREATED: %U\n:END:\n"
           )))
...
:END:
#+begin_src emacs-lisp
  (setq org-image-actual-width 800)  ;; nice default
#+end_src
** Hyphens to dots
:PROPERTIES:
...
:PROPERTIES:
:ID:       aa2a59e1-89b3-4878-8c18-e4c8544036e0
:END:
#+begin_src elisp
...
** Go
:PROPERTIES:
:ID:       fcf76827-a6b5-4c14-b284-b45239baf2c9
:END:
#+begin_src emacs-lisp
  (use-package ob-go
    :ensure t)
...
** C#
:PROPERTIES:
:ID:       8538bd2f-d7b9-4929-ae34-5ef7f3e6a008
:END:
#+begin_src elisp
...
#+begin_src elisp
  (use-package elfeed
    ...
    :bind (:map elfeed-search-mode-map
                ...
                ("0" . elfeed-read-general)
                ("1" . elfeed-read-ccc)
                ("2" . elfeed-read-aiml)
                ("3" . elfeed-read-prog)
                ("4" . elfeed-read-science)
                ("5" . elfeed-read-sports)))
  ...
  (defun elfeed-read-ccc ()
    (interactive)
    (my-elfeed-filter "@3-month-ago +unread +ccc " "Consciousnes, Computation, Cognition"))
...
* Unity
:PROPERTIES:
:ID:       032b2afa-4509-4bab-ae2f-626730dc5ca9
:END:
#+begin_src elisp
  ;; (add-to-list 'load-path "~/.emacs.d/external-lisp/unity.el")
  ;; (require 'unity)
  ;; (use-package unity
  ;;   :ensure nil
  ;;   :hook
  ;;   (after-init-hook . #'unity-build-code-shim)
  ;;   (after-init-hook . #'unity-setup))
#+end_src
* avy
:PROPERTIES:
