...
:END:
#+begin_src emacs-lisp
  ;; (if (display-graphic-p) (load-theme 'deeper-blue t))
...
#+begin_src elisp
  ...
  (global-set-key (kbd "C-c f c")
                  (lambda () (interactive) (my/file-shortcut "~/org/cabcs.org")))
  (global-set-key (kbd "C-c f l")
                  (lambda () (interactive) (my/file-shortcut "~/org/links.org")))
  (global-set-key (kbd "C-c f m")
                  (lambda () (interactive) (my/file-shortcut "~/org/meetings.org")))
  (global-set-key (kbd "C-c f s")
                  (lambda () (interactive) (my/file-shortcut "~/org/study.org")))
...
#+begin_src elisp
  ...
  (setq org-fast-tag-selection-single-key 'expert
        ...
        '(
          ...
          (:endgroup . nil)
          (:startgroup . nil)
          ("gcar" . ?G) ("aitr" . ?A) ("mixr" . ?M) ("qh" . ?Q) ("lod" . ?L)  ;; experiments
          (:endgroup . nil)
          ("ak" . ?a)
          ("data" . ?d)
          ("idea" . ?i)
          ...
          ("note" . ?n)
          ("prog" . ?p)
          ("star" . ?S)  ;; Starlab processes, documentation, etc.
          ("study" . ?s)
          ("test" . ?t)
          ("write" . ?w)
          ))
  ...
  (setq org-agenda-span 5
        ...
        org-agenda-prefix-format "%-10:T"  ;; Since I use tags over files
  ...
  (setq org-agenda-custom-commands
        '(
          ;; Experiments
          ("ee" "All Experiments"
           ((tags "aitr|gcar|mixr|qh|lod"
                  ((org-agenda-overriding-header "All Experiments\n")
                   (org-agenda-sorting-strategy '(tag-up todo-state-up priority-down))
                   (org-agenda-prefix-format "%-8:T")
                   ;; (org-agenda-hide-tags-regexp "aitr\\|gcar\\|mixr\\|lod\\|qh")
                   ))))
          ("ea" "AiTR"
           ((tags "aitr"
                  ((org-agenda-overriding-header "AiTR\n")
                   (org-agenda-sorting-strategy '(todo-state-up priority-down))
                   ))))
          ("eg" "GCAR"
           ((tags "gcar"
                  ((org-agenda-overriding-header "GCAR\n")
                   (org-agenda-sorting-strategy '(todo-state-up))
                   ))))
          ("eq" "QUICK-HUD"
           ((tags "qh"
                  ((org-agenda-overriding-header "QUICK-HUD\n")
                   (org-agenda-sorting-strategy '(todo-state-up))
                   ))))
          ("em" "MIXR"
           ((tags "mixr"
                  ((org-agenda-overriding-header "MIXR\n")
                   (org-agenda-sorting-strategy '(todo-state-up))
                   ))))
          ("el" "LOD"
           ((tags "lod"
                  ((org-agenda-overriding-header "LOD\n")
                   (org-agenda-sorting-strategy '(todo-state-up))
                   ))))
          ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
          ("h" "High priority"
          ...
          ("td" "Data"
           ((tags "data"
                  ((org-agenda-overriding-header "Data Inbox\n")
                   (org-agenda-sorting-strategy '(todo-state-up))
                   ))))
          ("te" "Emacs"
           ((tags "emacs"
  ...
  (setq org-capture-templates
        '(
          ...
          ("c" "Task" entry (file "~/org/cabcs.org")
           "* TODO %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n"
           :prepend t)
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-c n r") 'my/org-roam-node-from-cite)
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;; Citation tools
  ...
  (use-package citar
    ...
    :custom
  (citar-bibliography '("~/org/notes/bib/sources.bib"
                          "~/org/notes/bib/gcar.bib"
                          "~/org/notes/bib/aitr.bib"
                          )))
